...
"##########################################################
syn keyword verilogStatement   function task endfunction endtask
...
syn keyword OVM_Type analysis_fifo analysis_if avm_transport_imp avm_virtual_class
syn keyword OVM_Type cdns_hierarchy_only_printer cdns_list_printer cdns_phase_process_watcher
syn keyword OVM_Type default_report_server ovm_agent ovm_algorithmic_comparator
syn keyword OVM_Type ovm_analysis_export ovm_analysis_imp ovm_analysis_port ovm_barrier
syn keyword OVM_Type ovm_barrier_pool ovm_blocking_get_export ovm_blocking_get_imp
syn keyword OVM_Type ovm_blocking_get_peek_export ovm_blocking_get_peek_imp
syn keyword OVM_Type ovm_blocking_get_peek_port ovm_blocking_get_port ovm_blocking_master_export
syn keyword OVM_Type ovm_blocking_master_imp ovm_blocking_master_port ovm_blocking_peek_export
syn keyword OVM_Type ovm_blocking_peek_imp ovm_blocking_peek_port ovm_blocking_put_export
syn keyword OVM_Type ovm_blocking_put_imp ovm_blocking_put_port ovm_blocking_slave_export
syn keyword OVM_Type ovm_blocking_slave_imp ovm_blocking_slave_port ovm_blocking_transport_export
syn keyword OVM_Type ovm_blocking_transport_imp ovm_blocking_transport_port ovm_built_in_clone
syn keyword OVM_Type ovm_built_in_comp ovm_built_in_converter ovm_built_in_pair
syn keyword OVM_Type ovm_class_clone ovm_class_comp ovm_class_converter ovm_class_pair
syn keyword OVM_Type ovm_comparer ovm_component ovm_component_registry ovm_config_setting
syn keyword OVM_Type ovm_connector ovm_connector_base ovm_copy_map ovm_driver ovm_env ovm_event
syn keyword OVM_Type ovm_event_callback ovm_event_pool ovm_factory ovm_factory_override
syn keyword OVM_Type ovm_get_export ovm_get_imp ovm_get_peek_export ovm_get_peek_imp
syn keyword OVM_Type ovm_get_peek_port ovm_get_port ovm_hash ovm_hier_printer_knobs
syn keyword OVM_Type ovm_if_container ovm_in_order_built_in_comparator
syn keyword OVM_Type ovm_in_order_class_comparator ovm_in_order_comparator
syn keyword OVM_Type ovm_int_config_setting ovm_line_printer ovm_master_export ovm_master_imp
syn keyword OVM_Type ovm_master_port ovm_monitor ovm_nonblocking_get_export
syn keyword OVM_Type ovm_nonblocking_get_imp ovm_nonblocking_get_peek_export
syn keyword OVM_Type ovm_nonblocking_get_peek_imp ovm_nonblocking_get_peek_port
syn keyword OVM_Type ovm_nonblocking_get_port ovm_nonblocking_master_export
syn keyword OVM_Type ovm_nonblocking_master_imp ovm_nonblocking_master_port
syn keyword OVM_Type ovm_nonblocking_peek_export ovm_nonblocking_peek_imp
syn keyword OVM_Type ovm_nonblocking_peek_port ovm_nonblocking_put_export
syn keyword OVM_Type ovm_nonblocking_put_imp ovm_nonblocking_put_port
syn keyword OVM_Type ovm_nonblocking_slave_export ovm_nonblocking_slave_imp
syn keyword OVM_Type ovm_nonblocking_slave_port ovm_nonblocking_transport_export
syn keyword OVM_Type ovm_nonblocking_transport_imp ovm_nonblocking_transport_port
syn keyword OVM_Type ovm_object ovm_object_config_setting ovm_object_registry ovm_object_wrapper
syn keyword OVM_Type ovm_options_container ovm_packer ovm_peek_export ovm_peek_imp ovm_peek_port
syn keyword OVM_Type ovm_port_base ovm_port_base_base ovm_printer ovm_printer_knobs
syn keyword OVM_Type ovm_put_export ovm_put_imp ovm_put_port ovm_random_stimulus ovm_recorder
syn keyword OVM_Type ovm_report_global_server ovm_report_handler ovm_report_object
syn keyword OVM_Type ovm_report_server ovm_reporter ovm_req_rsp_driver ovm_root ovm_scope_stack
syn keyword OVM_Type ovm_scoreboard ovm_seq_item_prod_if ovm_slave_export ovm_slave_imp
syn keyword OVM_Type ovm_slave_port ovm_status_container ovm_string_config_setting ovm_subscriber
syn keyword OVM_Type ovm_table_printer ovm_table_printer_knobs ovm_test ovm_text_recorder
syn keyword OVM_Type ovm_threaded_component ovm_transaction ovm_transport_export
syn keyword OVM_Type ovm_transport_imp ovm_transport_port ovm_tree_printer ovm_tree_printer_knobs
syn keyword OVM_Type ovm_urm_message ovm_urm_message_format ovm_urm_override_operator
syn keyword OVM_Type ovm_urm_override_request ovm_urm_report_server ovm_void stream_info
syn keyword OVM_Type tlm_analysis_fifo tlm_b_get_export tlm_b_get_port tlm_b_put_export
syn keyword OVM_Type tlm_b_put_port tlm_blocking_get_if tlm_blocking_get_peek_if
syn keyword OVM_Type tlm_blocking_master_if tlm_blocking_peek_if tlm_blocking_put_if
syn keyword OVM_Type tlm_blocking_slave_if tlm_blocking_transport_if tlm_event tlm_fifo
syn keyword OVM_Type tlm_fifo_base tlm_get_export tlm_get_if tlm_get_peek_if tlm_get_port
syn keyword OVM_Type tlm_if_base tlm_master_if tlm_nb_get_export tlm_nb_get_port
syn keyword OVM_Type tlm_nb_put_export tlm_nb_put_port tlm_nonblocking_get_if
syn keyword OVM_Type tlm_nonblocking_get_peek_if tlm_nonblocking_master_if
syn keyword OVM_Type tlm_nonblocking_peek_if tlm_nonblocking_put_if tlm_nonblocking_slave_if
syn keyword OVM_Type tlm_nonblocking_transport_if tlm_peek_if tlm_put_export tlm_put_if
syn keyword OVM_Type tlm_put_port tlm_req_rsp_channel tlm_slave_if tlm_transport_channel
syn keyword OVM_Type tlm_transport_if tx_handle urm_command_line_processor_c urm_fifo
syn keyword OVM_Type ovm_scenario_base ovm_scenario ovm_scenario_noparam ovm_stimulus_scenario
syn keyword OVM_Type ovm_scenario_controller_base ovm_scenario_controller
syn keyword OVM_Type ovm_scenario_driver_base tlm_scenario_fifo tlm_scenario_req_rsp_channel
syn keyword OVM_Type ovm_scenario_driver ovm_scenario_driver_noparam request_driver
syn keyword OVM_Type ovm_req_rsp_sequence ovm_sequence ovm_random_sequence
syn keyword OVM_Type ovm_exhaustive_sequence ovm_simple_sequence ovm_sequence_item
syn keyword OVM_Type ovm_seq_item_cons_if ovm_sequencer ovm_seq_prod_if ovm_sequencer_base
syn keyword OVM_Type ovm_seq_cons_if ovm_virtual_sequencer
...
"highlight verilogComment guifg=#ffffff
   ...
   HiLink uvmDeprecatedClass     Type
